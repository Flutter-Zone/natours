...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/blanksonr/ckoajudkb079u17qpyrxri7zi' // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false
...
var userSettingsForm = document.querySelector('.form-user-settings'); // delegation
